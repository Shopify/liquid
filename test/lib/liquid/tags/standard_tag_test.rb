...
HERE
  ...
  def test_sort_only
    ...
    assert_template_result('0123456789', "{% for i in array sort:'asc' %}{{ i }}{%endfor%}", assigns)
    assert_template_result('9876543210', "{% for i in array sort:'desc' %}{{ i }}{%endfor%}", assigns)
  end
  
  def test_sort_with_limit
    assigns = {'array' => [3,2,1,5,6,8,9,7,0,4]}
    assert_template_result('01234', "{% for i in array limit:5 sort:'asc' %}{{ i }}{%endfor%}", assigns)
    assert_template_result('01234', "{% for i in array sort:'asc' limit:5 %}{{ i }}{%endfor%}", assigns)
    assert_template_result('98765', "{% for i in array limit:5 sort:'desc' %}{{ i }}{%endfor%}", assigns)
    assert_template_result('98765', "{% for i in array sort:'desc' limit:5 %}{{ i }}{%endfor%}", assigns)
  end
  
  def test_sort_with_offset
    assigns = {'array' => [3,2,1,5,6,8,9,7,0,4]}
    assert_template_result('56789', "{% for i in array offset:5 sort:'asc' %}{{ i }}{%endfor%}", assigns)
    assert_template_result('56789', "{% for i in array sort:'asc' offset:5 %}{{ i }}{%endfor%}", assigns)
    assert_template_result('43210', "{% for i in array offset:5 sort:'desc' %}{{ i }}{%endfor%}", assigns)
    assert_template_result('43210', "{% for i in array sort:'desc' offset:5 %}{{ i }}{%endfor%}", assigns)
  end
